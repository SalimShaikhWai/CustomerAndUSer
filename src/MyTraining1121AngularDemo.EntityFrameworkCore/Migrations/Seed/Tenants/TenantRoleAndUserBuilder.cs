...
using MyTraining1121AngularDemo.Notifications;
...
namespace MyTraining1121AngularDemo.Migrations.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(MyTraining1121AngularDemoDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var departmentHead = _context.Roles.IgnoreQueryFilters().FirstOrDefault(r => r.TenantId == _tenantId && r.Name == StaticRoleNames.Tenants.DepartmentHead);
            if(departmentHead == null)
            {
                _context.Roles.Add(new Role(_tenantId, StaticRoleNames.Tenants.DepartmentHead, StaticRoleNames.Tenants.DepartmentHead)
                {
                    IsStatic = true,
                    IsDefault = false
                }); ;
